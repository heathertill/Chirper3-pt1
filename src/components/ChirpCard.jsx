      ...
      <div>
         <div className="card border border-secondary rounded mb-1">
            <div className="card-body bg-white block p-0">
               <div className="media">
                  <img
                     className="align-self-start m-2 mr-3 border border-secondary rounded-circle"
                     style={{
                        height: 50,
                        width: 50,
                        backgroundColor: '#D6EAF8'
                     }}
                     src="https://openclipart.org/download/202776/pawn.svg"
                     alt="placeholder"
                  />
            ...
            <div
               className="card-footer d-flex flex-row p-0"
               style={{ height: '30px' }}
            >
               <div className="col-1">
                  <div>
